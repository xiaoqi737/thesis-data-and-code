...
%
function [lambda, omega_minus, omega_plus, theta, exitflag, z, fval] = solve_theta_chuantong(mu_bar, sigma2, x_ip, y_rp, p, delta)
...
c = [];
% 约束个数： m + l
ceq = zeros(m + l + 1, 1); % 最后一行用于目标分母 < 1 的约束（可选）
% i = 1..m:
for i = 1:m
